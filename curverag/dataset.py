...
class KGDataset(object):
    ...
    def get_examples(self, split, rel_idx=-1):
        ...
        Nate note: adds inverse relations and adds new relation id for those inverse relations. assumes inverse relations dont already exist
        """
